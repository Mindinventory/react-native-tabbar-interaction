...
export default class TabBar extends React.PureComponent {
  ...
  render() {
    ...
    const tabWidth =
      tabs.length > 0 ? width / tabs.length : console.error('please add tab data');
    ...
    if (tabs.length > 0) {
      return (
        <>
          <View
            style={{               
              backgroundColor: tabBarContainerBackground ? tabBarContainerBackground : '#fff',    
              position: 'absolute',
              bottom: 0    ,
          ...
          >
            ...
            <SafeAreaView style={[styles.container, { backgroundColor: tabBarBackgroundColor }]} />
          </View>
